  ...
  return (
    <div className="h-screen flex">
      ...
      <div className="w-7/10 bg-blue-500 flex flex-col justify-center items-center text-white p-10">
        <h1 className="text-5xl font-bold mb-4">Student Panel</h1>
        <p className="text-lg text-center max-w-lg">
          Manage school operations efficiently with Kids Corner Student Panel.
        </p>
      </div>

      {/* Right Section - Login Form */}
      <div className="w-3/10 bg-white flex flex-col justify-center items-center p-10 shadow-lg">
        <h2 className="text-2xl font-semibold mb-6 text-gray-800">Student Login</h2>
